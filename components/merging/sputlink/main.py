...
from library.timeml import TIMEX, TID, EVENT, EIID
from library.timeml import TLINK, RELTYPE, EVENT_INSTANCE_ID
from library.timeml import TIME_ID, CONFIDENCE, ORIGIN
