...
COMPONENTS = [ PREPROCESSOR, GUTIME, EVITA, SLINKET, S2T,
               BLINKER, CLASSIFIER, LINK_MERGER, ARGLINKER ]

# Defaults do not include the arglinker because it is really a TimeML+
# component, same will be true when we add simple entity recognition
DSI_DEFAULTS = {
    'simple-xml': {
...
class DocumentModel:
    ...
    def get_dct(self):
        """Accessor to retrieve the value of the DCT."""
        return self.metadata['dct']
